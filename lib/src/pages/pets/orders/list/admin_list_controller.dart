...
import 'package:app_beta/src/pages/pets/orders/detail/pets_orders_detail_page.dart';
...
class AdminOrdersListController {
  ...
  void openBottomSheet(Order order) async {
    isUpdated = await showMaterialModalBottomSheet(
        context: context,
        builder: (context) => PetsOrdersDetailPage(order: order)
    );
  ...
  void goToCategoryCreate() {
    Navigator.pushNamed(context, 'pets/categories/create');
  }

  void goToRestaurantOrder() {
    Navigator.pushNamed(context, 'pets/order/list');
  }

  void goToProductCreate() {
    Navigator.pushNamed(context, 'pets/products/create');
  }
