...
import 'package:app_beta/src/pages/pets/orders/detail/pets_orders_detail_controller.dart';
...
class PetsOrdersDetailPage extends StatefulWidget {

  Order order;

  PetsOrdersDetailPage({Key key, @required this.order}) : super(key: key);

  @override
  _PetsOrdersDetailPageState createState() => _PetsOrdersDetailPageState();
}

class _PetsOrdersDetailPageState extends State<PetsOrdersDetailPage> {

  PetsOrdersDetailController _con = new PetsOrdersDetailController();
