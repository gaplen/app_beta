...
import 'package:app_beta/src/pages/pets/products/create/pets_products_create_controller.dart';
...
class RestaurantProductsCreatePage extends StatefulWidget {
  ...
  @override
  _PetsProductsCreatePageState createState() => _PetsProductsCreatePageState();
}

class _PetsProductsCreatePageState extends State<RestaurantProductsCreatePage> {

  PetsProductsCreateController _con = new PetsProductsCreateController();
