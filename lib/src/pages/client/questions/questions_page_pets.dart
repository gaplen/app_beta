...
import 'package:app_beta/src/pages/client/questions/queston_page_controller.dart';
import 'package:app_beta/src/utils/my_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';

class ClientQuestionCreatePage extends StatefulWidget {
  const ClientQuestionCreatePage({Key key}) : super(key: key);

  @override
  _ClientQuestionCreatePageState createState() => _ClientQuestionCreatePageState();
}

class _ClientQuestionCreatePageState extends State<ClientQuestionCreatePage> {

  QuestionPageController _con = new QuestionPageController();
